...
public class Sistema {
    ...
    String mensaje;
    private int matrizDemanda[][] = new int[50][50];
    int posicionFila = 0;
    ...
    public long getTiempoTotP(){
         return p1.getTiempoTot();
    }
     
    public long getTiempoTotD(){
         return d1.getTiempoTot();
    }
    ...
    public int[][] getMatrizDemanda() {
        return matrizDemanda;
    }

    public void setMatrizDemanda(int[][] matrizDemanda) {
        this.matrizDemanda = matrizDemanda;
    }
    ...
    public Deteccion getD1() {
        return d1;
    }

    public void setD1(Deteccion d1) {
        this.d1 = d1;
    }
    ...
    public void imprimirvectotal (){
     ...
     d1.deteccion(recNecesariosD, recDisponiblesD, recAsignadosD, xrecTotal, numProcesosD);
     
     }
    public void llenarDemanda (int fila, int columna, int max){
       
        this.matrizDemanda[fila][columna] = max;
        System.out.println("En x = "+fila+" y = "+columna+" max rec = "+max);
        
    }  
     
     
     public boolean verificarDemanda (int fila, int columna, int max){
         
         
         if (matrizDemanda[fila][columna] < max){
    ...
    public boolean verificarRecursos (int columna, int max){
         
         
         if (this.recTotal[columna].getMax() < max){
       ...
       public void imprimirDemanda(){
        System.out.println(" ");
        System.out.println("----- Matriz Demanda Procesos ----");
        for (int i = 0; i < posicionFila; i++) {
            
            for (int j = 0; j < this.xrecTotal; j++) {
                
                System.out.print(matrizDemanda[i][j] + " ");
            }
            System.out.print("\n");
        }
        System.out.println("-----------------------------");
